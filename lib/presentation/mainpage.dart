...
import 'package:display_speed_project/common/background_pointer.dart';
import 'package:display_speed_project/common/overpass_repo.dart';
import 'package:display_speed_project/common/sign_painter.dart';
import 'package:display_speed_project/common/speed_unit.dart';
import 'package:display_speed_project/presentation/settingpage.dart';
        ...
        children: [
            ...
            child: ElevatedButton(
              onPressed: (){
                setState(() {
                  ...
                  do{
                    speedUnit = unitValues[
                      (unitValues.indexOf(speedUnit) + 1) % unitValues.length
                    ];
          ...
          Positioned(
            ...
            child: AnimatedBuilder(
              ...
              child: CustomPaint(
                foregroundPainter: TrainSignPainter(
                  speedLimit?.toString().substring(0 ,speedLimit.toString().length - 1) ?? '6'
                ),
              ),
            ),
          ),
